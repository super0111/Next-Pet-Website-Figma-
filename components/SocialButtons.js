  ...
  return (
    <>
      <div className="flex items-center cursor-pointer" >
        <Image src={facebook} width={16} height={16} /><span style={spanStyle}>Share</span>
      </div>
      <div className="flex items-center ml-6 cursor-pointer">
        <Image src={twitter} width={16} height={16} /><span style={spanStyle}>Tweet</span>
      </div>
      <div className="flex items-center ml-6 cursor-pointer">
        <Image src={pinterest} width={16} height={16} /><span style={spanStyle}>Pin it</span>
      </div>
    </>
  )
}