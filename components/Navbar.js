                ...
                <div className="w-4/5 text-left pb-12">
                  ...
                  <div className="mt-6 pl-14 flex">
                    ...
                    <ul className="mx-4">
                      ...
                      <li className="font-15 py-1.5 "><a href="">Dry Food</a></li>
                      <li className="font-15 py-1.5 "><a href="">Wet Food</a></li>
                      <li className="font-15 py-1.5 "><a href="">Veterinary Diets</a></li>
                      <li className="font-15 py-1.5 "><a href="">Minimally Processed Dog Food</a></li>
                      <li className="font-15 py-1.5 "><a href="">Grain Free Food</a></li>
                      <li className="font-15 py-1.5 "><a href="">Human-Grade Food</a></li>
                      <li className="font-15 py-1.5 "><a href="">Puppy Food</a></li>
                    </ul>

                    <ul className="mx-4">
                      <li className="font-bold font-15 pb-4">Treats</li>
                      <li className="font-15 py-1.5 "><a href="">Biscuits & Crunchy Treats</a></li>
                      <li className="font-15 py-1.5 "><a href="">Soft & Chewy Treats</a></li>
                      <li className="font-15 py-1.5 "><a href="">Dental Treats</a></li>
                      <li className="font-15 py-1.5 "><a href="">Jerky Treats</a></li>
                      <li className="font-15 py-1.5 "><a href="">Training Treats</a></li>
                      <li className="font-15 py-1.5 "><a href="">Bones & Chews</a></li>
                    </ul>

                    <ul className="mx-4">
                      <li className="font-bold font-15 pb-4">Supplies</li>
                      <li className="font-15 py-1.5 "><a href="">Clothes & Accessories</a></li>
                      <li className="font-15 py-1.5 "><a href="">Beds</a></li>
                      <li className="font-15 py-1.5 "><a href="">Bowls & Feeders</a></li>
                      <li className="font-15 py-1.5 "><a href="">Collars, Leashes, and Harnesses</a></li>
                      <li className="font-15 py-1.5 "><a href="">Crates & Kennels</a></li>
                      <li className="font-15 py-1.5 "><a href="">Gates, Doors, and Pens</a></li>
                      <li className="font-15 py-1.5 "><a href="">Grooming</a></li>
                      <li className="font-15 py-1.5 "><a href="">Poop Bags & Cleaning Supplies</a></li>
                      <li className="font-15 py-1.5 "><a href="">Toys</a></li>
                      <li className="font-15 py-1.5 "><a href="">Training & Behavior</a></li>
                      <li className="font-15 py-1.5 "><a href="">Travel & Outdoor</a></li>

                    </ul>

                    <ul className="mx-4">
                      <li className="font-bold font-15 pb-4">Health & Wellness</li>
                      <li className="font-15 py-1.5 "><a href="">Vitamins & Supplements</a></li>
                      <li className="font-15 py-1.5 "><a href="">Flea & Tick Prevention</a></li>
                      <li className="font-15 py-1.5 "><a href="">First Aid</a></li>
                      <li className="font-15 py-1.5 "><a href="">Dog Calming Aids</a></li>
                      <li className="font-15 py-1.5 "><a href="">Dog Pharmacy</a></li>
                      <li className="font-15 py-1.5 "><a href="">Dog DNA Kits</a></li>
                    </ul>
